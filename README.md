...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | AWS region where Secrets Manager secrets are stored | `string` | `"us-east-1"` | no |
...
| <a name="input_eso_service_account_name"></a> [eso\_service\_account\_name](#input\_eso\_service\_account\_name) | Name of the ESO Kubernetes service account (must have IRSA annotation for Secrets Manager access) | `string` | `"eso-service-account"` | no |
